...
{   
  ...
  move_base_msgs::MoveBaseGoal goal1_pre;//定义第二个目标点 ，广州馆 
  ...
  goal1_pre.target_pose.pose.position.y = 1.077; //目标点y  
  goal1_pre.target_pose.pose.orientation.z = -0.026;  
  goal1_pre.target_pose.pose.orientation.w = 1.000;//目标点姿态四元数表示  
  move_base_msgs::MoveBaseGoal goal1;//定义第二个目标点 ，广州馆 
  goal1.target_pose.header.frame_id = "map";  
  goal1.target_pose.header.stamp = ros::Time::now();  
  goal1.target_pose.pose.position.x = 2.48;//目标点x  
  goal1.target_pose.pose.position.y = 1.077; //目标点y  
  goal1.target_pose.pose.orientation.z = -0.026;  
  goal1.target_pose.pose.orientation.w = 1.000;//目标点姿态四元数表示  

move_base_msgs::MoveBaseGoal goal2_pre;//定义第一个目标点 北京馆 
  ...
  goal2_pre.target_pose.pose.position.y = 0.13;//目标点y  
  goal2_pre.target_pose.pose.orientation.z = 0.03;
  goal2_pre.target_pose.pose.orientation.w = 0.99;//目标点姿态四元数表示 
  move_base_msgs::MoveBaseGoal goal2;//定义第一个目标点 北京馆 
  goal2.target_pose.header.frame_id = "map";  
  goal2.target_pose.header.stamp = ros::Time::now();  
  goal2.target_pose.pose.position.x = 2.48;//目标点x 
  goal2.target_pose.pose.position.y = 0.13;//目标点y  
  goal2.target_pose.pose.orientation.z = 0.03;
  goal2.target_pose.pose.orientation.w = 0.99;//目标点姿态四元数表示
